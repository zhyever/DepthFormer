...
from mmseg.models.utils import PatchEmbed, vit_convert

from .resnet import make_res_layer, BasicBlock, Bottleneck
...
class ConvVisionTransformer(BaseModule):
    ...
    def __init__(self,
                 ...
                 style='pytorch'):
        super(ConvVisionTransformer, self).__init__()
    ...
    def init_weights(self):
        if isinstance(self.pretrained, str):
            ...
            super(ConvVisionTransformer, self).init_weights()
    ...
    def conv_stem(self, x):
        conv_stem = self._conv_stem_conv1(x)
    ...
    def forward(self, inputs):
        outs = []
        conv_stem = self.conv_stem(inputs)
    ...
    def train(self, mode=True):
        super(ConvVisionTransformer, self).train(mode)
