...
model = dict(
    ...
    backbone=dict(
        ...
        window_size=12),
    neck=dict(
        type='DepthAffMultiLevelNeck',
        in_channels=[128, 256, 512, 1024],
        out_channels=[128, 256, 512, 1024],
        scales=[1, 1, 1, 1]),
    decode_head=dict(
        type='UpsampleHead',
        # in_channels=[1024 + 256, 512 + 256, 256 + 256, 128 + 256],
        in_channels=[1024 + 256, 512, 256, 128],
        in_index=[0, 1, 2, 3, 4], # no use, align to mmseg.
        # up_sample_channels=[1024 + 256, (512 + 256) // 2, (256 + 256) // 2, (128 + 256) // 2],
        up_sample_channels=[1024 + 256, 512, 256, 128],
